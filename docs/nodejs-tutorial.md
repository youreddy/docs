...
The __clientId__, __clientSecret__ and __domain__ are available on the [settings](@@uiURL@@/#/applications/@@account.clientId@@/integrate) page. Keep this page open. We will need one last thing later on.
